...
void GameEngineGUI::Initialize()
{
    ...
    NewDir.Move("Font");
    io.Fonts->AddFontFromFileTTF(GameEngineString::AnsiToUTF8(NewDir.GetPlusFileName("malgun.ttf").GetFullPath()).c_str(), 18.0f, nullptr, io.Fonts->GetGlyphRangesKorean());
